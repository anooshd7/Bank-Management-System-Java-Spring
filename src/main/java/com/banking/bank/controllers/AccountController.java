...
public class AccountController {
    ...
    public CurrentAccount createCurrentAccount(@RequestBody CurrentAccount account) {
        return accountService.createCurrentAccount(account);
    }

    @PostMapping("/loan")
    public LoanAccount createLoanAccount(@RequestBody LoanAccount account) {
        return accountService.createLoanAccount(account);
    }
